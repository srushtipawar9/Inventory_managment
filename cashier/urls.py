...
urlpatterns = [
    ...
    path('stock/bulk-upload/', views.BulkUploadStock, name='BulkUploadStock'),
    path('stock/bulk-upload/sample-csv/', views.DownloadSampleInventoryCSV, name='DownloadSampleInventoryCSV'),
